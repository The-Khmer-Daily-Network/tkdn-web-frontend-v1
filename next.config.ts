      ...
      // Apply security headers to all other routes
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value:
              "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://*.googletagmanager.com https://*.google-analytics.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https: https://www.google-analytics.com https://*.google-analytics.com https://*.googletagmanager.com https://i.ytimg.com https://img.youtube.com; font-src 'self' data:; connect-src 'self' https://api.thekhmerdailynetwork.com https://staging-api.thekhmerdailynetwork.com http://127.0.0.1:8000 http://localhost:8000 https://www.google-analytics.com https://*.google-analytics.com https://www.googletagmanager.com https://*.googletagmanager.com https://www.google.com https://stats.g.doubleclick.net; media-src 'self' blob: http://127.0.0.1:8000 http://localhost:8000 https://*.digitaloceanspaces.com https://*.cdn.digitaloceanspaces.com https://*.youtube.com https://*.googlevideo.com; frame-src 'self' https://www.youtube.com https://www.youtube-nocookie.com;",
          },
          {
